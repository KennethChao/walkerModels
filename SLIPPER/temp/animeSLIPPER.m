% clc;
% close all
function phasePortraitSLIPPER('phasePotrait_zf', 'constantTorque', ret, plotParms)
...
% plot(phivec,zfdvec,'linewidth',1.5,'color', c(a,:))
% plot(tvec,xvec)
% hold on
% plot(tvec,zvec)
% plot(tvec,xfvec)
% hold on
% plot(tvec,phivec)
plot3(phivec, zcdvec, zcvec, 'linewidth', 1.5, 'color', c(a, :)) %,
